...
int main() {
	...
	char option, *periods[] = {"Dai", "Day", "Week", "Month", "Year"}, whatPeriod1[6], whatPeriod2[6];
	...
	do {
		...
		switch(option) {
			case 'D':
				strcpy(whatPeriod1, periods[0]);
				strcpy(whatPeriod2, periods[1]);
				break;
			case 'W':
				strcpy(whatPeriod1, periods[2]);
				strcpy(whatPeriod2, periods[2]);
				break;
			case 'M':
				strcpy(whatPeriod1, periods[3]);
				strcpy(whatPeriod2, periods[3]);
				break;
			case 'Y':
				strcpy(whatPeriod1, periods[4]);
				strcpy(whatPeriod2, periods[4]);
				break;
			case 'Q':
				printf("Programmers:\n\n");
		...
		period = getPeriod(whatPeriod1, whatPeriod2);
		totIncome = getIncomes(period, whatPeriod1, whatPeriod2);
		displayTotAvg(period, totIncome, whatPeriod1, whatPeriod2);
	} while (option != 'Q');
