...
int main() {
	...
	char option, *periods[] = {"Day", "Dai", "Week", "Month", "Year"}, whatPeriod1[100], whatPeriod2[100], _D[] = "Day", _D2[] = "Dai", _W[] = "Week", _M[] = "Month", _Y[] = "Year", periodName;
	...
	do {
		...
		switch(option) {
			case 'D':
				strcpy(whatPeriod1, periods[1]);
				strcpy(whatPeriod2, periods[0]);
				break;
			case 'W':
